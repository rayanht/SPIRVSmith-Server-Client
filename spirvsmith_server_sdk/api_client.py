...
from spirvsmith_server_sdk import rest
from spirvsmith_server_sdk.configuration import Configuration
from spirvsmith_server_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from spirvsmith_server_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.flush_queues_queues_delete  # this is an instance of the class Endpoint
        api_instance.flush_queues_queues_delete()  # this invokes api_instance.flush_queues_queues_delete.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.flush_queues_queues_delete.callable or self.callable in this class
